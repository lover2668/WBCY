  ...
  scan: function (e) {
    ...
    wx.scanCode({
      ...
      success: function (e) {
        ...
        if (scanResult.indexOf(point.locationName) < 0){
          wx.showModal({
            title: '提示',
    ...
    wx.showModal({
      ...
      success: function (e) {
        if (e.confirm) {
          ...
          submitData.userName = wx.getStorageSync("userName");
          submitData.patrolType = wx.getStorageSync("currentPatrolType");
          submitData.startTime = wx.getStorageSync("startTime") || "";
          console.log(submitData);
          // return;

          util.setRequest(config.urls.setWatchInfoUrl, submitData, function (data, errCode) {
            if (errCode) {
              var frequencies = data.watchInfo.frequencies;
              ...
              util.getRequest(config.urls.getWatchInfoUrl, { officeId: officeId, workDate: workDate }, function (data, errCode) {
                if (errCode) {
